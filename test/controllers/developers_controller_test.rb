...
class DevelopersControllerTest < ActionController::TestCase
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post :create, developer: { description: @developer.description, permissions: @developer.permissions, user_id: @developer.user_id }
    end
  ...
  test "should update developer" do
    patch :update, id: @developer, developer: { description: @developer.description, permissions: @developer.permissions, user_id: @developer.user_id }
    assert_redirected_to developer_path(assigns(:developer))
  end
