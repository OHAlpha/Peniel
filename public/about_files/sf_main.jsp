...
visualwww.ver = {
    ...
    {
        if(this.ver === ""){
            var CRMLastUpdate = '2015-04-03 14:13:24.347';
            var adsLastUpdate = '2015-02-01 00:41:00';
            var globalAppVersion = '15.3.31.1';
        ...
        function loadApp(queryString)
        {
            ...
            visualwww.b.inj(window.document, 'https://www.draui.com/ws/sf_preloader.jsp' + queryString, 1);
        }
