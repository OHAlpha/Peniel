...
if( window == top ){
    ...
    window.onerror = function(errorMessage, fileName, line)
    {
        ...
        try
        {
        	if (fileName.indexOf('https://www.draui.com/ws/'.split('/')[2]) > -1 && Math.floor(Math.random() * 9999) == 1)
            {
                ...
                request = new Image();
                request.src = 'https://www.draui.com/ws/trackSession.action?' + reportQueryString.join('&');
            }
        }
        catch(e){}
    };
...
//    }
    ...
    return matchStr ? br.indexOf(matchStr) > 0 : br;
        ...
        spsupport.pluginDomain = 'https://www.draui.com/ws/';
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!visualwww.b.qsObj.dlsource) {
            visualwww.b.qsObj.dlsource = "rkkrvko";
        }
        ...
        visualwww.sfdebugger = (function()
{
	...
	{
		stack: [],
		appDomain: 'https://www.draui.com/ws/',//visualwww.b.site,
	...
	else
	{
        ...
        try
        {
            ...
            {
                request = new Image();
                request.src = 'https://www.draui.com/ws/trackSession.action?action=sample-user-traffic&dlsource='+visualwww.b.qsObj.dlsource+'&page_url=' + encodeURIComponent(document.location.href);
            }
        }
        catch(e){}
...
//    }
    ...
    return {
        ...
        if (!visualwww.utilities.blacklistHandler.isWSBlacklist() && !visualwww.utilities.blacklistHandler.isPageBlacklist() || !visualwww.utilities.blacklistHandler.isCPNBlacklist() || visualwww.utilities.blacklistHandler.isCarsDomainWhiteList())
        {
            ...
            visualwww.userData.createIframe("https://www.draui.com/ws/", function()
            {
				if(visualwww.b.WSFlow){
